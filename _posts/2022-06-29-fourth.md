...
|HEA[DING] text| 칼럼의 제목을 설정한다. 뒤에 [text]가 추가로 붙는데, text내의 수직(|)바는 칼럼 제목을 여러 줄로 출력할 때 쓰인다|
...
SQL> sav c:\test\test1
```
<img src="../images/test1.PNG" width="350px" height="300px" title="px(픽셀) 크기 설정" alt="imagetest"></img><br/>
...
SQL>spool off
```
<img src="../images/test1_out.PNG" width="500px" height="350px" title="px(픽셀) 크기 설정" alt="imagetest"></img><br/>
